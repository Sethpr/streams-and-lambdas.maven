...
public class StreamFilter {
    ...
    //one of these is wrong, I don't know which though
    /**
    ...
    public Person[] toArrayOneLine() {
        return personStream.filter((p) -> p.getName().startsWith(startingCharacter)).collect(Collectors.toList()).toArray(new Person[0]);

    }

    //again i say, one of these is wrong and i dont know which
